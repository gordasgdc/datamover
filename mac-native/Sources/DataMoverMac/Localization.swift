...
enum L {
    ...
    fileprivate static let table: [String: [AppLanguage: String]] = [
        ...
        "activation.donation": [.ro: "Cei %@ sunt o donatie, nu un pret de lista — ma ajuta sa acopar costurile de dezvoltare si sa continui sa intretin si imbunatatesc aplicatia.",
                                 .en: "The %@ is a donation, not a list price — it helps me cover development costs and keep maintaining and improving the app.",
                                 .es: "Los %@ son una donación, no un precio de lista — me ayudan a cubrir los costes de desarrollo y a seguir manteniendo y mejorando la aplicación."],
        "activation.donationPromo": [.ro: "Preț special %@ (în loc de %@), doar o donație unică — ma ajuta sa acopar costurile de dezvoltare.",
                                      .en: "Special price %@ (instead of %@), still a one-time donation — it helps me cover development costs.",
                                      .es: "Precio especial %@ (en lugar de %@), sigue siendo una donación única — me ayuda a cubrir los costes de desarrollo."],
